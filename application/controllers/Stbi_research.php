...
class Stbi_research extends CI_Controller
{
    ...
    function index()
    {
        ...
        $docFile = "/var/www/html/assets/tut_files/Lingkungan_dan_Setting_Field_untuk_Tabel_Base0.rtf";
        $document = new Jstewmc\Rtf\Document($docFile);
        
        // $document = new Document($docFile);
        $space = new Jstewmc\Rtf\Element\Text(' ');
        $root_document = $document->getRoot()->getChild(1);
        
        // $b = $root_document->getFirstChild();
        // $space->insertBefore($root_document);
        $text = $document->write('text');
        // $check = $b->getNextText();
        // $check1 = $check->getNextText();
        // $check2 = $check1->getNextText();
        // $check3 = $check2->getNextText();
        echo "<pre>";
        // var_dump($check2);echo "<br>";
        // print($check1);echo "<br>";
        // print($check2);echo "<br>";
        // var_dump($check3);echo "<br>";
        var_dump($text);
        // print($check2);
        echo "</pre>";
